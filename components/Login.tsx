...
export const Login = () => {
    ...
    return (
        <div className="min-h-screen bg-white flex items-center justify-center p-4 font-sans transition-colors duration-300">
            <div className="w-full max-w-[440px] space-y-8">
                ...
                <div className="text-center space-y-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold text-gray-900 tracking-tight">Pioneer DMS Portal</h1>
                ...
                <p className="text-center text-xs text-gray-400 font-medium">
                    &copy; 2026 Pioneer DMS Portal Workforce Management. All rights reserved.
                </p>
            </div>
        </div>
    );
